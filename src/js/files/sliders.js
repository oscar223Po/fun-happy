...
function initSliders() {
	...
	if (document.querySelector('.gallery-gest__slider')) { // Вказуємо склас потрібного слайдера
		// Створюємо слайдер
	...
	if (document.querySelector('.main-history__slider')) { // Вказуємо склас потрібного слайдера
		// Створюємо слайдер
